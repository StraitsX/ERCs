...
A compliance guard should have logic to store and retrieve whitelisted merchants/redeemers and blacklisted addresses to fulfil the basic premise of a PBM. In addition, additional logic could be added to fulfill other compliance goals.
