...
A compliance guard for PBM unwrapping must be specified. The compliance guard can either be implemented within the PBM contract or referenced as an external contract, and is checked upon unwrapping of the PBM.
...
interface IPBMRC1 is IERC173, IERC5679Ext1155 {
    ...
    /// contract expiry, and the compliance guard.
    ...
    /// such as purpose-bound conditions (ie: a compliance guard determining whether a PBM is permitted to be transferred to or to be unwrapped)
